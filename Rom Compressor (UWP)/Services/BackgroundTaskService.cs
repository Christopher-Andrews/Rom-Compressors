...
using Rom_Compressor__UWP_.Activation;
using Rom_Compressor__UWP_.BackgroundTasks;
using Rom_Compressor__UWP_.Helpers;

using Windows.ApplicationModel.Activation;
using Windows.ApplicationModel.Background;

namespace Rom_Compressor__UWP_.Services
{
